/*
  ...
  1. Schema update for chat sessions and insights
    - Add completed boolean column to chat_sessions
    - Add performance indexes
    - Fix function conflict issue

  2. Function Changes
    - Update complete_session to properly handle existing functions
    - Fix get_recent_sessions function
...
-- Explicitly drop the specific function with full signature to avoid ambiguity
...
-- Explicitly drop function with full signature

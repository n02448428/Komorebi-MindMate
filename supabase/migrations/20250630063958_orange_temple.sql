/*
  # Improve Chat Sessions and Insights Schema
  
  1. Changes
    - Add `completed` boolean column to chat_sessions
    - Add convenience functions for session management
    - Add index on insights session_id for better query performance
  
  2. Security
    - No changes to RLS
    
  3. Functions
    - Add `complete_session` function to mark a session as complete and generate an insight
    - Add `get_recent_sessions` function to retrieve recent sessions
*/

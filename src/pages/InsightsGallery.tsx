...
The file was missing several closing brackets and components. The complete structure should now be properly nested with all required closures. The main issues were:
...
The file should now be properly structured with all required closures and components. Let me know if you need any clarification or if there are still any issues to resolve.
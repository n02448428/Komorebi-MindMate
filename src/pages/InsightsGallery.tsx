...
The rest of the code remains the same. These additions complete the missing sections and provide the necessary imports for the icons used in the interface.
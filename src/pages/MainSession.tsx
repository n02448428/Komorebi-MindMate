...
const MainSession: React.FC = () => {
  ...
  }, [profile?.is_pro === true, user, isGuest, sessionType, timeOfDay.greeting, storage, messages.length]);
  ...
  }, [timeOfDay.shouldAutoStart, sessionStartTime, hasCompletedBothToday, isSessionExpired, storage]);

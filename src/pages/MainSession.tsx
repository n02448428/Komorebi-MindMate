        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="relative flex items-center gap-3">
            ...
            <AnimatePresence>
              {showControls && (
                <motion.div
                  ...
                  className={`absolute right-full mr-4 grid grid-cols-3 md:grid-cols-6 gap-x-6 gap-y-3 backdrop-blur-sm border border-white/20 rounded-2xl p-3 ${
                    sessionType === 'morning' 
                      ? 'bg-white/20' 
                      : 'bg-white/10'
                  }`}
                >
                  ...
                  <button
                    ...
                    className={`p-3 rounded-xl backdrop-blur-sm border border-white/20 transition-all duration-200 cursor-pointer flex items-center justify-center ${
                      sessionType === 'morning'
                        ? 'bg-white/20 hover:bg-white/30 text-gray-700'
                        : 'bg-white/10 hover:bg-white/20 text-white'
                    }`}
            ...
            <button
             ...
             className={`p-3 rounded-2xl backdrop-blur-sm border border-white/20 transition-all duration-200 flex items-center justify-center ${
                sessionType === 'morning'
                  ? 'bg-white/20 hover:bg-white/30 text-gray-700'
                  : 'bg-white/10 hover:bg-white/20 text-white'
              }`}

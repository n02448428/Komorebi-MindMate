        ...
        <div className="p-6 border-b border-white/10 backdrop-blur-sm">
          ...
          {isGuest && (
            <div className={`mb-4 p-3 rounded-xl text-center ${
              ...
              <p className="text-sm">Guest mode: Your conversation history will be lost when you close your browser. <button onClick={() => navigate('/auth')} className="font-medium underline">Create an account</button> to save it.</p>
            </div>
          )}

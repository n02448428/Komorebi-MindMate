...
import { useAuth } from '../conimport { ChevronLeft, ChevronRight, Home, User, Settings, Crown, LogIn, Eye, EyeOff, SkipForward, Shuffle, RefreshCw, Archive, Sparkles, GalleryVertical as Gallery } from 'lucide-react'ionLimitReached from '../components/SessionLimitReached';

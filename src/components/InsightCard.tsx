...
And at the very end of the file, add the final closing bracket for the MainSession component:
...
These additions should complete the component structure and resolve the syntax errors in the file. The component should now be properly structured with all necessary brackets closed and required imports included.